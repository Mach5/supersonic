...
Section "Supersonic"
  ...
  # Take backup of existing supersonic-service.exe.vmoptions
  CopyFiles /SILENT $INSTDIR\supersonic-service.exe.vmoptions $TEMP\supersonic-service.exe.vmoptions
  ...
  File ..\..\..\target\supersonic-agent.exe.vmoptions
  File ..\..\..\target\supersonic-agent-elevated.exe
  File ..\..\..\target\supersonic-agent-elevated.exe.vmoptions
  File ..\..\..\target\supersonic-service.exe
  File ..\..\..\target\supersonic-service.exe.vmoptions
  ...
  # Restore supersonic-service.exe.vmoptions
  CopyFiles /SILENT  $TEMP\supersonic-service.exe.vmoptions $INSTDIR\supersonic-service.exe.vmoptions
  Delete $TEMP\supersonic-service.exe.vmoptions
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\supersonic-agent.exe.vmoptions"
  Delete "$INSTDIR\supersonic-agent-elevated.exe"
  Delete "$INSTDIR\supersonic-agent-elevated.exe.vmoptions"
  Delete "$INSTDIR\supersonic-booter-jar-with-dependencies.jar"
  Delete "$INSTDIR\supersonic-service.exe"
  Delete "$INSTDIR\supersonic-service.exe.vmoptions"
