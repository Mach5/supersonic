...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.cache.title"/></td><td class="ruleTableCell">
        <c:forEach items="${model.caches}" var="cache">
            ${cache.statistics}<br>
        </c:forEach>
    </td></tr>
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.homepage.title"/></td><td class="ruleTableCell"><a target="_blank" href="https://github.com/porkcharsui/supersonic">Github</a></td></tr>
</table>
